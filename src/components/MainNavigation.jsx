...
const MainNavigation = ({ prefix = '' }) => {
  ...
  return ( 
    <nav style={{ boxShadow: colors.primaryColor, backgroundColor: colors.backgroundColor }} className=' fixed shadow-[#faa819]/30l shadow-xl sha top-0 left-0 right-0 m-auto w-full max-w-[1920px] z-20 flex justify-between items-center px-8 md:px-12 lg:px-24 2xl:px-32 h-16 md:h-32'>
