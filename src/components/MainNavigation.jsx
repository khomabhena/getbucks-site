...
const MainNavigation = ({ prefix = '' }) => {
  ...
  return ( 
    <nav style={{ backgroundColor: colors.backgroundColor }} className=' fixed top-0 left-0 right-0 m-auto w-full max-w-[1920px] z-20 flex justify-between items-center px-4 h-16 md:h-32'>
      <a href="/">
