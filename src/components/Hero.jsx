...
const Hero = () => {
  ...
  return (
    <section className=' pt-8 lg:32 xl:pt-48 2xl:pt-56 flex flex-col gap-12 justify-center px-8 min-h-[400px] md:min-h-[524px]'>
        ...
        <h1 className=' ease-in-out md:pt-32 lg:pt-32 text-xl md:text-2xl 2xl:text-2xl text-slate-900 font-semibold text-center'>
