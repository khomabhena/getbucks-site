...
const AboutUsCard2 = ({ title, subtitle, text, points }) => {
  return (
    <div className=' basis-full md:basis-1/2 lg:basis-1/3 md:min-h-[350px] h-fit flex justify-center items-center my-2 mx-2'>
      ...
      <div className=' relative w-full md:w-[500px] lg:w-[600px] xl:w-[400px] min-h-[250px] md:min-h-[250px] rounded-4xl shadow-lg shadow-[#faa819] bg-gradient-to-r from-gray-100 to-gray-200 pb-8'>
        <img className=' hidden lg:block w-32 absolute -mt-8 -ml-8 top-0 left-0' src="/about/icon-01.png" alt="" />
        <img className=' hidden lg:block w-32 absolute -mb-8 -mr-8 bottom-0 right-0' src="/about/icon-02.png" alt="" />
