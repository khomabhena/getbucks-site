...
const AboutUsCard2 = ({ title, subtitle, text, points }) => {
  return (
    <div className=' basis-full md:basis-1/2 lg:basis-1/3 md:min-h-[350px] h-fit flex justify-center items-center my-2'>
      ...
      <div className=' relative w-full min-w-[300px] md:w-[350px] lg:w-[350px] xl:w-[350px] min-h-[250px] md:min-h-[250px] rounded-4xl shadow-lg shadow-[#faa819] bg-gradient-to-r from-gray-100 to-gray-200 pb-8'>
