  ...
  return (
    <section style={{ backgroundColord: colors.backgroundColor }} 
      ...
      'rounded-xl flex flex-col md:gap-4 md:flex-row'} `}>
          ...
          <div className={` flex flex-col justify-center pr-2 ${ reverse ? 'xl:text-end' : ''} `}>
            ...
            <h4 className={` ${heading ? '' : 'hidden'} text-lg md:text-2xl font-light mt-4`}>{heading}</h4>
            <p className=' mt-8 text-sm md:text-xl text-gray-700'>{text}</p>
          </div>
