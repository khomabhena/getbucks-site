...
import LandingPageContentCard2 from '../components/LandingPageContentCard2'
    ...
    <section className='mt-8 md:mt-24 flex flex-col gap-4 items-center'>
      ...
      <p className=' mb-48 mt-2 text-sm text-center md:text-3xl font-light text-gray-700'>{subHeading}</p>
      {
        data?.map(({ index, image, title, description}) => (
          ...
          <div className={` ${index % 2 == 0 ? 'md:flex-row-reverse': 'md:flex-row'} mt-12 min-h-32 w-full flex flex-col md:flex-row items-center flex-wrapp`}>  
            ...
            <div className=' basis-1 self-center md:basis-2/5'>
              <LandingPageContentCard2 index={index} image={image} />
            </div>
