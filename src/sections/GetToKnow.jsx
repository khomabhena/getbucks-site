...
const GetToKnow = () => {
  ...
  return (
    <section className=' mt-48 pb-8 flex flex-col lg:flex-row xl:h-[450px] px-12' style={{ backgroundColor: colors.primaryColor }}>
      ...
      <div className=' basis-3/5 mt-12 md:pr-12'>
        ...
        <p className=' text-sm md:text-lg pb-4'>{data.text2}</p>
      </div>
    </section>
  )
}
